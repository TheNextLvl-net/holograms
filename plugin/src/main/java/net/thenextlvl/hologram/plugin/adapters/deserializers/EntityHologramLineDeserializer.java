package net.thenextlvl.hologram.plugin.adapters.deserializers;
...
@NullMarked
public final class EntityHologramLineDeserializer extends StaticHologramLineDeserializer<EntityHologramLine> {
    ...
    protected EntityHologramLine createLine(final CompoundTag tag, final TagDeserializationContext context) {
        ...
        return new PaperEntityHologramLine(hologram, null, type);
    }
}
