...
import net.thenextlvl.hologram.plugin.commands.action.argument.ConnectCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.CyclePageCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.PlaySoundCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.RunConsoleCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.RunPlayerCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.SendActionbarCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.SendMessageCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.SendTitleCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.SetPageCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.TeleportCommand;
import net.thenextlvl.hologram.plugin.commands.action.argument.TransferCommand;
import net.thenextlvl.hologram.plugin.commands.arguments.EnumArgumentType;
...
import static net.thenextlvl.hologram.plugin.commands.action.ActionCommand.actionArgument;
