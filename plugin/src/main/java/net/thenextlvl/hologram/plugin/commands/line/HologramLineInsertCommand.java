package net.thenextlvl.hologram.plugin.commands.line;
...
import net.thenextlvl.hologram.plugin.commands.suggestions.tags.TagSuggestionProvider;
...
public final class HologramLineInsertCommand extends BrigadierCommand {
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> create(final HologramPlugin plugin) {
        ...
        return command.create().then(hologramArgument(plugin).then(line
                ...
                .then(Commands.literal("paged").executes(command::insertPagedLine))));
    }
