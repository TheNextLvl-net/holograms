...
import static net.thenextlvl.hologram.plugin.commands.HologramCommand.permissionArgument;
...
final class HologramPageViewPermissionCommand extends SimpleCommand {
    ...
    private int set(final CommandContext<CommandSourceStack> context) {
        ...
        final var message = !success ? "nothing.changed"
                : viewPermission != null
                ? "hologram.page.view-permission.set"
                : "hologram.page.view-permission.removed";
