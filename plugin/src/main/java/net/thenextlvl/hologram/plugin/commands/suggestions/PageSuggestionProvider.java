package net.thenextlvl.hologram.plugin.commands.suggestions;
...
import static net.thenextlvl.hologram.plugin.commands.suggestions.LineSuggestionProvider.getTooltip;
