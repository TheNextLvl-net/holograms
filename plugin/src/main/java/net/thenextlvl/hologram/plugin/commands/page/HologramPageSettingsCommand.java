...
import net.thenextlvl.hologram.plugin.commands.page.settings.HologramPageSettingsIntervalCommand;
import net.thenextlvl.hologram.plugin.commands.page.settings.HologramPageSettingsPauseCommand;
import net.thenextlvl.hologram.plugin.commands.page.settings.HologramPageSettingsRandomCommand;
