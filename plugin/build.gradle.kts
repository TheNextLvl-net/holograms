...
dependencies {
    paperweight.paperDevBundle("26.3.build.25-alpha")
...
paper {
    name = "Holograms"
    main = "net.thenextlvl.hologram.plugin.HologramPlugin"
    apiVersion = "1.21.8"
...
tasks.shadowJar {
    ...
    relocate("org.bstats", "net.thenextlvl.hologram.plugin.metrics.bstats")
    relocate("dev.faststats", "net.thenextlvl.hologram.plugin.metrics.faststats")
}
